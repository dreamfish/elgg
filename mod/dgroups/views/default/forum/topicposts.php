...
?>
	...
	<div class="topic_post"><!-- start the topic_post -->
		...
		<?php
		    ...
		    //if the comment owner is looking at it, or admin, or dgroup owner they can edit
        ...
        ?>
		        ...
		        <?php
			        ...
			        echo elgg_view("output/confirmlink",array(
														'href' => $vars['url'] . "action/dgroups/deletepost?post=" . $vars['entity']->id . "&topic=" . get_input('topic') . "&dgroup=" . get_input('dgroup_guid'),
                	...
                	$topic = elgg_view('input/hidden', array('internalname' => 'topic', 'value' => get_input('topic')));
		  			$dgroup = elgg_view('input/hidden', array('internalname' => 'dgroup', 'value' => get_input('dgroup_guid')));
...
?>
				...
				<?php
					echo elgg_view('input/form', array('action' => "{$vars['url']}action/dgroups/editpost", 'body' => $form_body, 'internalid' => 'editforumpostForm'));
				?>
					</div>
		        </p>
