...
/* elgg open source		blue 			#4690d6 - rgb(0,48,170)*/
/* elgg open source		dark blue 		#0054a7 - red #ea1124 */
/* elgg open source		light blue	 	#bbdaf7 - rgb(0,48,170) */
...
ul#df_buttons li a span {
	margin: 0;
	padding: 0;
	display: none;
}

ul#df_buttons li a.button_projects:hover span {
	margin: 0;
	padding: 0;
	display: block;
	width: 540px;
...
ul#df_buttons li a.button_membership:hover span {
	margin: 0;
	padding: 0;
	display: block;
	width: 540px;
