...
<div class="contentWrapper">
	...
	<table class='custom_profile_fields_actions_list'>
		...
		<tr>
			<td>
				<input type="button" class="submit_button" value="<?php echo elgg_echo("profile_manager:actions:export"); ?>" onclick="document.location.href='<?php echo $vars['url']; ?>pg/profile_manager/export/<?php echo CUSTOM_PROFILE_FIELDS_GROUP_SUBTYPE;?>?<?php echo $security_params;?>';">
			</td>
			<td>
